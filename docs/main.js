...
if (dayNum == 09 && monthNum == 03) {
  document.getElementById("random").innerHTML = "My Birthday is Tomorrow so Get Ready. (;";
} else if (dayNum == 10 && monthNum == 03) {
  document.getElementById("random").innerHTML = "It's My Birthday. (:";
  var bits = 80; // how many bits
  var speed = 33; // how fast - smaller is faster
  var bangs = 5; // how many can be launched simultaneously (note that using too many can slow the script down)
  var colours = new Array("#03f", "#f03", "#0e0", "#93f", "#0cf", "#f93", "#f0c");
  // bluered green purplecyanorangepink
...
} else if (dayNum == 11 && monthNum == 03) {
  document.getElementById("random").innerHTML = "Well, last night was my birthday and you was not here! >_<";
} else {
  let randomwords = [
