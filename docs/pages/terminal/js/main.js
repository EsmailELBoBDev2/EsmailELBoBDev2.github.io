...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        welcome: "Welcome!\nIn order to use the website please feel free to type 'help' to list all commands or just use the side menu :)\n\n",
...
var files = (function () {
    ...
    Singleton.defaultOptions = {
        "about.txt": "nothing here yet",
        "my_cv.txt": "https://esmailelbob.hashbase.io/pages/myCV/myCV.pdf",
        "contact.txt": "contact-work.cyprinoidean <at> simplelogin.fr",
        "social_networks.txt": "Keybase: https://keybase.io/esmailelbob\nMinds: https://www.minds.com/esmailelbob\nPeertube: https://peertube.social/video-channels/b9595f39-b25f-43eb-81d8-f3068863db3d/videos\nGithub: https://github.com/EsmailELBoBDev2\nGitlab: https://gitlab.com/EsmailELBoBDev2",
        "get_back": "https://esmailelbob.hashbase.io"
    };
    return {
        getInstance: function (options) {
            instance === void 0 && (instance = new Singleton(options));
